...
import project2.project.Service.AdminService;
import project2.project.Service.OrderService;
import project2.project.vo.Admin;
import project2.project.vo.Book;
import project2.project.vo.User;
  ...
  public void run() {
    ...
    while (true) {
      ...
      switch (choiceNum) {
        ...
        case 9 -> {
          Admin admin = new Admin(name,tel);
          AdminService adService = new AdminService(admin);
          adService.menuAdminLogin();
        }
      }
    }
  }
